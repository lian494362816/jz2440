...
int key_signal_init(void)
{
    ...
    key_signal_class_dev = device_create(key_signal_class, NULL, MKDEV(key_signal_major, 0), NULL, KEY_SIGNAL_CLASS_DEV_NAME);
...
{
    device_destroy(key_signal_class, MKDEV(key_signal_major, 0));
