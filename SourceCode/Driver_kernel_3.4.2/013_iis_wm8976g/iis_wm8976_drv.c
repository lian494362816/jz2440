...
static struct device *wm8976_class_dev = NULL;
...
static __init int wm8976_init(void)
{
    ...
    wm8976_class_dev = device_create(wm8976_class, NULL, MKDEV(wm8976_major, 0), NULL, WM8976_CLASS_DEV_NAME);
    if (!wm8976_class_dev)
    {
...
{
    device_destroy(wm8976_class, MKDEV(wm8976_major, 0));
