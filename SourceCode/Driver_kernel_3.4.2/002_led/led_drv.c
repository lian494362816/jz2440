...
int led_init(void)
{
    ...
    led_class_dev = device_create(led_class, NULL, MKDEV(_g_led_major, 0), NULL, LED_CLASS_DEV_NAME);
...
void led_exit(void)
{
    device_destroy(led_class, MKDEV(_g_led_major, 0));
