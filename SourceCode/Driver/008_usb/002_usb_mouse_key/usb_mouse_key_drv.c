...
static int usb_mouse_key_probe(struct usb_interface *intf, const struct usb_device_id *id)
{
    ...
    usb_mouse_dev.vir_addr = usb_buffer_alloc(usb_mouse_dev.dev, usb_mouse_dev.size, GFP_ATOMIC, &usb_mouse_dev.phy_addr);
...
err_free_buff:
    usb_buffer_free(usb_mouse_dev.dev, usb_mouse_dev.size, usb_mouse_dev.vir_addr, usb_mouse_dev.phy_addr);
