...
#define     NFCMMD                   __REG_BYTE(0x4E000008)  //NAND flash command
...
#define     UTXH1                    __REG_BYTE(0x50004020)  //UART 1 transmission hold
#define     URXH1                    __REG_BYTE(0x50004024)  //UART 1 receive buffer
...
#define     UTXH2                    __REG_BYTE(0x50008020)  //UART 2 transmission hold
#define     URXH2                    __REG_BYTE(0x50008024)  //UART 2 receive buffer
