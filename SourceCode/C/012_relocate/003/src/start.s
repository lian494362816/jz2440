...
_start:
    ...
    */
	...
	/* relocate .data */
	ldr r1, =data_load_addr /* data segment address in bin file */
	ldr r2, =data_start     /* data segment relocate address, running-address */
	ldr r3, =data_end       /* data segment end addrerss */
